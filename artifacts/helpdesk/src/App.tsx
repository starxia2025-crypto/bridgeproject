...
import AssistanceRequestPage from "@/pages/assistance-request";
import AssistanceInboxPage from "@/pages/assistance-inbox";
import ExternalApisPage from "@/pages/external-apis";
...
function Router() {
  ...
  if (location === "/assistance/request") return <ProtectedRoute component={AssistanceRequestPage} roles={["admin_cliente", "manager", "usuario_cliente"]} />;
  if (location === "/assistance/inbox") return <ProtectedRoute component={AssistanceInboxPage} roles={["superadmin", "tecnico"]} />;
  if (location === "/integrations/apis") return <ProtectedRoute component={ExternalApisPage} roles={["superadmin", "tecnico"]} />;
